...
export interface Exercise { id: string; name: string; slug: string; description: string; instructions: string; category: ExerciseCategory; difficulty: "gentle" | "steady" | "focused"; pattern: number[]; defaultTempo: number; defaultDuration: number; singDurationMs: number; completionMode: ExerciseCompletionMode; pitchHoldToleranceCents?: number; beatsPerNote?: number; countInBeats?: number; restBetweenSequencesMs?: number; pitchEvaluationStartRatio?: number; pitchEvaluationEndRatio?: number; pitchSmoothing: PitchSmoothing; supportsPitchTracking: boolean; supportsTransposition: boolean; referenceToneEnabled: boolean; }
